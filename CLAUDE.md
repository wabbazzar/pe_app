...
- `scripts/merge-duplicate-firms.mjs` — merged three duplicate firm records
  ...
  of that merge (the runner has since added new firms; 463 as of this writing).
