...
- `src/lib/quests.ts` — 18 quests, each rolls up to one value
...
- `scripts/merge-duplicate-firms.mjs` — merged three duplicate firm records
  ...
  of that merge (the runner has since added new firms; 457 as of this writing).
